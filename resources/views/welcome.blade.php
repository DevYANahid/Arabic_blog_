    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="{{ url('/') }}" class="d-flex align-items-center">
                <img src="{{ asset('assets/img/logo.png') }}" style="width: 100px; padding: 8px 0" alt="">
            </a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 hero-video hero-video-desktop">
                        <iframe src="{{ asset('assets/video/desktop.mp4') }}" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <!-- Video for mobile -->
                    <div class="col-12 hero-video hero-video-mobile">
                        <iframe src="{{ asset('assets/video/moble.mp4') }}" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="{{ asset('assets/img/hero-carousel/hero-carousel-1.jpg') }}"
                                alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/img/hero-carousel/hero-carousel-2.jpg') }}"
                                alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/img/hero-carousel/hero-carousel-3.jpg') }}"
                                alt=""></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="video-container">
                            <iframe src="{{ asset('assets/video/video-1.mp4') }}" allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="video-container">
                            <iframe src="{{ asset('assets/video/video-2.mp4') }}" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4 mb-3">
                        <img src="{{ asset('assets/img/b-1.jpg') }}" class="img-fluid business-image" alt="">
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 mb-3">
                        <img src="{{ asset('assets/img/b-2.jpg') }}" class="img-fluid business-image" alt="">
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 mb-3">
                        <img src="{{ asset('assets/img/b-3.jpg') }}" class="img-fluid business-image"
                            alt="">
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 mb-3">
                        <img src="{{ asset('assets/img/b-4.jpg') }}" class="img-fluid business-image"
                            alt="">
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 mb-3">
                        <img src="{{ asset('assets/img/b-5.jpg') }}" class="img-fluid business-image"
                            alt="">
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 mb-3">
                        <img src="{{ asset('assets/img/b-6.jpg') }}" class="img-fluid business-image"
                            alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="container footer-top">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6 footer-about">
                    <a href="{{ url('/') }}" class="d-flex align-items-center">
                        <img src="{{ asset('assets/img/logo.png') }}" style="width: 100px; padding: 8px 0"
                            alt="">
                    </a>
